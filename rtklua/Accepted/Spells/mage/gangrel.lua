gangrel_mage = {
	cast = function(player, target)
		...
		if player:hasDuration("gangrel_mage") then
		...
		player:setDuration("gangrel_mage", duration)
		player.state = 4
...
kwisin_mask_mage = {
	cast = function(player)
		...
		if player:hasDuration("kwisin_mask_mage") then
			player:removeDuras(morphs)
			return
		end
		...
		player:setDuration("kwisin_mask_mage", duration)
		player.state = 4
...
mingken_mask_mage = {
	cast = function(player)
		...
		if player:hasDuration("mingken_mask_mage") then
			player:removeDuras(morphs)
			return
		end
		...
		player:setDuration("mingken_mask_mage", duration)
		player.state = 4
		player.disguise = 89
...
ohaeng_mask_mage = {
	cast = function(player)
		...
		if player:hasDuration("ohaeng_mask_mage") then
			player:removeDuras(morphs)
			return
		end
		...
		player:setDuration("ohaeng_mask_mage", duration)
		player.state = 4
