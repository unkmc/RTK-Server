pilfer = {
	...
	requirements = function(player)
		...
		local description = "Allows you to grab items up to 2 tiles away in the direction you are facing. Will not pick up items that a player is standing on or an item belonging to someone's deathpile"
