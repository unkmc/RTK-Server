bomber_war_bomb3 = {
	while_cast_500 = function(player)
		local m = 15050
		local x = core.gameRegistry["bombx3" .. player.name]
		local y = core.gameRegistry["bomby3" .. player.name]
	...
	uncast = function(player)
		if player.m == 15050 then
			bomber_war_bomb3.explode(player)
		end
	end,

	explode = function(player)
		bomber_war_bomb3.breakBoxes(player)
		bomber_war_bomb3.kill(player)
		bomber_war_bomb3.animation(player)
		bomber_war_bomb3.cleanup(player)
	...
	cleanup = function(player)
		...
		setPass(15050, x, y, 0)
		core.gameRegistry["bombx3" .. player.name] = 0
		core.gameRegistry["bomby3" .. player.name] = 0
	end
}
